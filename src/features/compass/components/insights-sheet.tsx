 ...
 * decoration: these are four different KINDS of claim — what the goal is, how
 * it is going overall, the two headline numbers, and the day-by-day shape —
 * and running them together as a column of text leaves the reader to do the
 * grouping. A number that matters gets a tray of its own.
 *
