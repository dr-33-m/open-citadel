 ...
 *
 * The rest of the app answers an approval with `ApprovalSheet`, a modal
 ...
 *
 * Inline rather than teaching the sheet a third session, and the reason is
 ...
 *
 * The wording is `approvalCopy`, the same function the sheet uses, so the two
