  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.metaRow}>
        ...
        />
        <ThemedText type="labelSm" color={colors.text.secondary} style={styles.bookTitle}>
          {entry.bookTitle}
        </ThemedText>
      ...
      {hasNotes && (
        <View style={styles.noteContainer}>
          <ThemedText type="bodySm" color={colors.text.secondary} style={styles.quoteIcon}>
            ❝
          </ThemedText>
            ...
            <View style={styles.noteRow}>
              {hasMultiple && (
                ...
                >
                  <ChevronLeft
                    size={16}
                    color={noteIndex === 0 ? colors.surface.highest : colors.text.secondary}
                  />
                </Pressable>
              )}
