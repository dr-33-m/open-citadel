...
const messageVariants = tv({
  slots: {
    ...
    avatar: 'shrink-0',
    /*
     * Citadel adaptations of the library defaults: the house bubble is
     * `px-3 py-2` at 82% of the row (the exact shell chat-bubble.tsx drew
     * before Message), and corners stay square — the zeroed `--radius-*`
     * tokens in theme.css already flatten the rounded corners upstream sets.
     */
    content: 'max-w-[82%] gap-1',
